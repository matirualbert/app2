...
fun Intentcreate() {
    ...
    Column(
        ...
        OutlinedButton(
            onClick = {
                val intent= Intent(Intent.ACTION_CALL, android.net.Uri.parse("tel:"+"+254708843339"))
        ...
        OutlinedButton(
            onClick = {
                val uri= android.net.Uri.parse("tel:0708443000")
...
class ContextCompat {
    companion object {
        fun checkSelfPermission(context: Any, callPhone: String): Any {
